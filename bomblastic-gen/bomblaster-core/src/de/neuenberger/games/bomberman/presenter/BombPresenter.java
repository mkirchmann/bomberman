...
public class BombPresenter extends BaseSubPresenter<Bomb, IDynamicCellContent> {
	...
	public void create() {
		super.create();
		bombModel = BombermanGame.loadObjFile("bomb.obj");

	}

	@Override
	public void render(List<Bomb> bombs, Camera camera) {
		getShader().begin();
	...
	protected void render(Bomb m) {
		this.bombModel.render(getShader());
	}
