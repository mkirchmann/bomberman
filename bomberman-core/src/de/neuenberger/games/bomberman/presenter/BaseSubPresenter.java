...
public abstract class BaseSubPresenter<M extends IDynamicCellContent, H extends IDynamicCellContent> {
	...
	protected ShaderProgram createShader() {
		ShaderProgram fireShader = ResourceManager.getInstance().getResource("simple", ShaderProgram.class).getResource();
	...
	public void render(List<M> render, Camera camera, float delta) {
		shader.begin();
