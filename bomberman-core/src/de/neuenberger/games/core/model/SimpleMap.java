...
public class SimpleMap implements SearchableMap {
	...
	/**
	 * Checks if there is a danger at the give position for the given live content
	 * @param position given position
	 * @param liveContent given live content
	 * @return Return true if there is a danger, false otherwise
	 */
	public boolean containsDangerFor(MapPosition position,
			LiveContent liveContent) {
		NCell cell = getCell(position);
		return cell.isDangerousFor(liveContent);
	}
}
